...
namespace MigraDoc.Core.Migrations
{
    ...
    [Migration("20200925114431_familystatusid")]
    partial class familystatusid
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MigraDoc.Core.Entities.DocumentEntity", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("MigraDoc.Core.Entities.DocumentEntity", b =>
                {
                    ...
                    b.HasOne("MigraDoc.Core.Entities.UserEntity", "UserEntity")
                        .WithMany()
            ...
            modelBuilder.Entity("MigraDoc.Core.Entities.UserDataEntity", b =>
                {
                    ...
                    b.HasOne("MigraDoc.Core.Entities.FamilyStatusEntity", "FamilyStatus")
                        .WithMany()
